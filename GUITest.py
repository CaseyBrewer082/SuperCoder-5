...
class GUI(Frame):
    ...
    def createButtons(self):
        ...
        button_r1 = Button(master, state='active', image = (colourscheme[0 or 1]), \
                          command= lambda: [addColour('singlebutton r1.gif'), flashButtons(self)])
        button_r1.place(x = 360, y = 15)

        #button 2
        button_b1 = Button(master, state='active', image = img2, \
                          command= lambda: addColour('singlebutton b1.gif'))
        button_b1.place(x = 454, y = 60)
        #button 3
        button_o1 = Button(master, state='disabled', image = img4, \
                          command= lambda: addColour('singlebutton o1.gif'))
        button_o1.place(x = 476, y = 162)
        #button 4
        button_gr1 = Button(master, state='disabled', image = img6, \
                           command= lambda: addColour('singlebutton gr1.gif'))
        button_gr1.place(x = 406, y = 255)
        #button 5
        button_g1 = Button(master, state='disabled', image = img8, \
                          command= lambda: addColour('singlebutton g1.gif'))
        button_g1.place(x = 314, y = 255)
        #button 6
        button_p1 = Button(master, state='disabled', image = img10, \
                          command= lambda: addColour('singlebutton p1.gif'))
        button_p1.place(x = 244, y = 162)
        #button 7
        button_br1 = Button(master, state='disabled', image = img12, \
    ...
    def flashButtons(self):
        ...
        global button_r1
        if clack0:
            button_r1.config(image = img7)
            clack0 = False
        else:
            button_r1.config(image = img0)
            clack0 = True
...
img2 = PhotoImage(file = 'singlebutton b1.gif')
img4 = PhotoImage(file = 'singlebutton o1.gif')
img6 = PhotoImage(file = 'singlebutton g1.gif')
img8 = PhotoImage(file = 'singlebutton gr1.gif')
img10 = PhotoImage(file = 'singlebutton p1.gif')
img12 = PhotoImage(file = 'singlebutton br1.gif')
img1 = PhotoImage(file = 'singlebutton r2.gif')
img3 = PhotoImage(file = 'singlebutton b2.gif')
img5 = PhotoImage(file = 'singlebutton o2.gif')
img7 = PhotoImage(file = 'singlebutton g2.gif')
img9 = PhotoImage(file = 'singlebutton gr2.gif')
img11 = PhotoImage(file = 'singlebutton p2.gif')
